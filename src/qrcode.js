...
function getQRCodeImage(text, options = {}) {
  // Create a new QRCode instance with the provided text and options
  const qrCode = new QRCode(document.createElement('div'), {
    ...
    useSVG: false, // Use SVG if specified
  });
  // Draw the QR code
  qrCode.makeCode(text);

  return qrCode._oDrawing._elCanvas.toDataURL('image/png'); // Return the QR code as a PNG data URL
}

window.qrcode = getQRCodeImage; // Expose the function globally for convenience
